 ...
 */
final class Version20241125144242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE todo_item (id INT AUTO_INCREMENT NOT NULL, todo_list_id INT NOT NULL, description VARCHAR(255) NOT NULL, priority INT NOT NULL, INDEX IDX_40CA4301E8A7DCFA (todo_list_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
